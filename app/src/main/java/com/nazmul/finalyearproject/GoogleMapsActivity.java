...

{
        ...
        switch (v.getId()){
            case R.id.search_address:
                ...
                if (!TextUtils.isEmpty(address)){
                    ...
                    Toast.makeText(this,"write any Location name...",Toast.LENGTH_LONG).show();
                }
                break;
            ...
            case R.id.restaurant_nearby:
                ...
                Toast.makeText(this, "showing for nearby restaurant", Toast.LENGTH_SHORT).show();
                break;
    ...
    private String getUrl(double latitide,double longitude,String nearbyPlace){
        ...
        googleURL.append("&key=" + "AIzaSyAlxA0qOHNjDA8DzIem8RbSEGMQCiYYdM8");
