...
import com.nazmul.finalyearproject.Utils.NotificationHelper;
...
public class MyFCMService extends FirebaseMessagingService {
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        if (remoteMessage.getData() != null){
            ...
            addRequestToUsereInformation(remoteMessage.getData());

        }
    }

    private void addRequestToUsereInformation(Map<String, String> data) {
        //pending request
    ...
    private void sendNotification(RemoteMessage remoteMessage) {
        ...
        String content = "Friend Request from"+ data.get(Common.FROM_NAME);
    ...
    private void sendNotificationWithChannel(RemoteMessage remoteMessage) {
        ...
        builder = helper.getNewRealTrackingTimeNotification(title,content,defaultSound);
    ...
    public void onNewToken(String s) {
        ...
        if (user != null){
            ...
            token.child(user.getUid()).setValue(s);
